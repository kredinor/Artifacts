namespace Arc.Tests.CommandLineParserTests
{
    ...
    [TestClass]
    public class When_parsing_int_arguments
    {
        public class CommandLine : CommandLineParser
        {
            ...
            [CommandLineArgument("opt5", 4, DefaultValue = 27)]
        ...
        {
            var commandLine = new CommandLine("exe 7 \"13\"");

            Assert.AreEqual(7, commandLine.Option1);
